...
describe ("ES6 | ByteArray", function () {
	...
	var flipBytes = function (read, write, readOffset, writeLength) {
	...
	it ("testEndianness", function () {
		...
		var defaultEndian = getSystemEndianness ();
	...
	/*static private function serializeByteArray(ba) {
		var str = "";
	...
	it ("testCompressUncompressLzma", function() {
		...
		var data = new ByteArray();
		var str = "Hello WorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorldWorld!";
		data.writeUTFBytes(str);
