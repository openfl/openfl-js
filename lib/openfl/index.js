const openfl = {
	...
	DateTimeFormatter: require("./globalization/DateTimeFormatter").default,
	DateTimeNameContext: require("./globalization/DateTimeNameContext").default,
	DateTimeNameStyle: require("./globalization/DateTimeNameStyle").default,
	DateTimeStyle: require("./globalization/DateTimeStyle").default,
	LastOperationStatus: require("./globalization/LastOperationStatus").default,
	LocaleID: require("./globalization/LocaleID").default,
	...
	clearInterval: require("./utils/clearInterval").default,
	...
	setInterval: require("./utils/setInterval").default,
