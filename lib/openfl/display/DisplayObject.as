package openfl.display {
	 ...
	 */
	public class DisplayObject extends EventDispatcher implements IBitmapDrawable /*#if openfl_dynamic implements Dynamic<DisplayObject> #end*/ {
		...
		protected function get_loaderInfo ():LoaderInfo { return null; }
		...
		protected function get_mouseX ():Number { return 0; }
		...
		protected function get_mouseY ():Number { return 0; }
		...
		protected function get_root ():DisplayObject { return null; }
		...
		// #if flash
		// @:noCompletion @:dox(hide) @:require(flash10) public var rotationY:Number { return 0; }
		// #end
		
		// #if flash
		// @:noCompletion @:dox(hide) @:require(flash10) public var rotationZ:Number { return 0; }
		// #end
		 ...
		 */
		public function globalToLocal (pos:Point):Point { return null; }
